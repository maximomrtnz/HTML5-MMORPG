...
function findPath(map, collisions, pathStart, pathEnd){
	// shortcuts for speed
	var	abs = Math.abs;
	var	max = Math.max;
	var	pow = Math.pow;
	...
	var worldWidth = map.width;
	var worldHeight = map.width;
	...
	*/
	...
	function canWalkHere(x, y){
		var i = y * map.width + x;
		return ((collisions[i] != null) &&	(collisions[i] <= maxWalkableTileNum));
	};
